...
\begin{enumerate}[leftmargin=18pt,itemsep=1pt,topsep=2pt]
  \item Using geometric deep learning to gain insights from spatial omics data
...
\begin{enumerate}[leftmargin=18pt,itemsep=3pt,topsep=2pt]
  ...
  \item[] \textit{In review:} Segger: fast and accurate cell segmentation of imaging-based spatial transcriptomics data via heterogeneous graph representation learning. \textit{Nature Methods} (submitted 2026).
\end{enumerate}
...
\subentrytitle{Segger: cell segmentation of imaging-based spatial transcriptomics data --- Master's thesis}{2025.3 -- 2026.3}
\begin{itemize}[leftmargin=18pt,itemsep=1pt,topsep=2pt]
  \item Built a heterogeneous graph neural network with cross-modal attention over individual transcripts and cells to improve transcript-to-cell assignment
  \item Achieved high-precision cell segmentation on spatial transcriptomics data; work forms part of the Segger project, manuscript in review at \textbf{Nature Methods}
\end{itemize}
